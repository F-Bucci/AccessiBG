...
1. [**Testing Frontend**](#testing-frontend)
   * 1.1. [**Organizzazione del package**](#organizzazione-del-package)
   * 1.2. [**Strumenti utilizzati**](#strumenti-utilizzati)
   * 1.3. [**JUnit**](#junit)
   * 1.4. [**Casi di test con JUnit**](#casi-di-test=con-junit)
   * 1.4. [**L'utilizzo di Playwright**](#lutilizzo-di-playwright)
   * 1.5. [**Come avviare i test di Playwright**](#come-avviare-i-test-di-playwright)
   * 1.6. [**Copertura dei test**](#copertura-dei-test)
