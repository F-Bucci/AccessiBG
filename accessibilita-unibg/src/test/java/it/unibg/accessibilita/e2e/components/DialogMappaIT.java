...
class DialogMappaIT extends BaseE2ETest{
	@Test
	void dialogOstacoloMostraFoto() {
	...
	@Test
	//test che verifica che cliccando una stanza questo ha una foto
	void dialogStanzaMostraFoto() {
		page.navigate("http://localhost:8080/struttura/Edificio%20D");
