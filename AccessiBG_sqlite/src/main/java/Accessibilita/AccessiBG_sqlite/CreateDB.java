...
public class CreateDB {
	// questo � il percordo relativo del file che contiene il DB
		public static String DB_REL_FILE = "C:\\Data\\AccessiBG\\AccessiBG_sqlite\\src\\main\\resources\\sqlite_db\\AccessiBG.db3";
